...
export interface VoiceInfo {
  ...
  f0?: number;
  /**
   * Диктор читает по-русски с акцентом.
   *
   * У silero таких большинство: 29 голосов из 34 — дикторы народов СНГ. В
   * дубляже акцент слышно сразу, поэтому автоподбор отдаёт главные роли
   * носителям и спускается к остальным, только когда свободных не осталось.
   */
  accent?: boolean;
}
