...
export interface Meta {
  ...
  source_path?: string;
  /**
   * Название оригинала: у ссылки — из разбора, у локального файла — из имени.
   *
   * Нужно, чтобы итог можно было отличить от оригинала не только по имени файла:
   * в теги дубляжа уходит «<название> (RU)». У старых рабочих каталогов поля нет,
   * и название берётся из имени исходного файла.
   */
  source_title?: string;
