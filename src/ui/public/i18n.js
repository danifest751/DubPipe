...
const DICTIONARY = {
  ...
  'settings.ttsEngineNote': {
    ru: 'piper не требует ничего дополнительно. silero даёт 34 русских голоса вместо четырёх и синтезирует заметно быстрее, но ему нужен Python с torch.',
    en: 'piper needs nothing extra. silero offers 34 Russian voices instead of four and synthesises much faster, but it needs Python with torch.',
  },
  ...
  'settings.defaultVoiceNote.silero': {
    ru: 'Голоса silero: 34 русских, из них 19 женских. Работают без сети. Героине подбирается голос её высоты.',
    en: 'The silero voices: 34 Russian, nineteen of them female. They work offline, and an actress is matched by pitch.',
  },
  ...
  'env.tool.local': { ru: 'в служебном каталоге', en: 'in the working folder' },
  'env.tool.system': { ru: 'в системе', en: 'on the system' },
  ...
  'compare.apply': { ru: 'Применить', en: 'Apply' },
  ...
  'env.state.warn': { ru: 'можно без него', en: 'optional' },
  'env.state.blocked': { ru: 'нужно', en: 'required' },
